...
<body class="bg-base-200">
  ...
  <div class="hero min-h-screen">
    <div class="hero-content text-center">
      <div class="max-w-md">
        <h1 class="text-5xl font-bold">Welcome to the Library System!</h1>
        <p class="py-6">
          <?php echo get_user_full_name($mysqli, $_SESSION['user_id']); ?>
        </p>
      </div>
    </div>
  </div>
  ...
  <script defer>
    ...
    // Retrieve stored theme preference if available.
